...
class InheritUsers(models.Model):
    ...
    allow_return_products = fields.Boolean(string="POS Order - Cancel Bill")
    pos_cash_difference = fields.Boolean(string="POS Cash Difference")
    allow_remove_programs = fields.Boolean(string="Enable Remove Programs")
