...
class StoreTargetDivisionLine(models.Model):
    ...
    target_date = fields.Date(string="Date", tracking=True, copy=False, )
    day_name = fields.Char(string="Day", tracking=True, copy=False, )
    week_name = fields.Char(string="Wk", copy=False, tracking=True)
    wd_we = fields.Char(string="WD/WE", tracking=True, copy=False)
    date_no = fields.Integer(string="Date No", tracking=True, copy=False, )
    ...
    parent_2_name = fields.Char(string="Category", readonly=True, copy=False, tracking=True)
    class_name = fields.Char(string="Class", copy=False, tracking=True)
    brick_name = fields.Char(string="Brick", copy=False, tracking=True)
