...
class ResConfigSettings(models.TransientModel):
    ...
    nh_picking_allowed_days = fields.Integer(
        string='Picking Date Allowed Days',
        config_parameter='nh_inventory.nh_picking_allowed_days',
        default=7,
        help='Number of days for which a exchange date is allowed.'
    )
