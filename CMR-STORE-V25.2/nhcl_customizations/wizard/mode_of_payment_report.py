    ...
    def get_mop_payments(self):
        ...
        for rec in self:
            ...
            mop_totals = {
                ...
                'cheque': 0.0, 'gift voucher': 0.0,'credit note settlement': 0.0,
            }
            ...
            grand_total = sum(mop_totals.values())
            ...
            lines_to_create.append({
                ...
                'credit_note_settlement': mop_totals['credit note settlement'],
                'credit_note_issues': credit_note_issues,
                'grand_total': grand_total,
                'total': grand_total - credit_note_issues,
