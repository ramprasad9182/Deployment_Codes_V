    ...
    def get_last_first_bill_num(self):
        try:
            ...
            for store in self:
                ...
                bill_count = len(order_lines.mapped('order_id'))
                ...
                if order_lines:
                    ...
                    first_bill_no = sorted_lines[0].order_id.pos_reference
                    last_bill_no = sorted_lines[-1].order_id.pos_reference
    ...
    def get_last_first_bill_num_in_excel(self):
        ...
        try:
            ...
            for store in self:
                ...
                first_bill_no = first_order.tracking_number or first_order.pos_reference if first_order else 'N/A'
                last_bill_no = last_order.tracking_number or last_order.pos_reference if last_order else 'N/A'
...
class PoslfbReportline(models.TransientModel):
    ...
    bill_count = fields.Integer('Bill Count')
