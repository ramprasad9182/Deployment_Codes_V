...
class PosZReport(models.TransientModel):
    ...
    pos_session_ids = fields.Many2many('pos.session', 'pos_sessions_close', string="POS Session(s)",
    ...
    def generate_z_report(self):
        ...
        return self.env.ref('nhcl_bi_pos_reports.action_z_report_print').report_action([], data=data)


class ClosedSessionReport(models.AbstractModel):
    _name = 'report.nhcl_bi_pos_reports.report_closed_session'
