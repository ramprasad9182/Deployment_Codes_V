...
class GeneralSettings(models.TransientModel):
    ...
    global_tracking_enable = fields.Boolean(string="Global Tracking", config_parameter='ks_access_manager_ninja.global_tracking_enable')
...
class IrUiMenu(models.Model):
    ...
    def _load_menus_blacklist(self):
        ...
        active_direct_sales = self.env['ir.config_parameter'].sudo().get_param('ks_access_manager_ninja.global_tracking_enable')
