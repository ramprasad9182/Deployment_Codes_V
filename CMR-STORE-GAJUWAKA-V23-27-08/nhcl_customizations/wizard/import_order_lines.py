...
class order_line_wizard(models.TransientModel):
    ...
    def action_import_barcodes(self):
        ...
        for row in sheet.iter_rows(min_row=2, values_only=True):
            ...
            # GS1 BARCODE
            # ==============================
            if 'P' in barcode and self.sale_order_id.transfer_type == 'regular':
                lot_code = barcode[barcode.find('P'):]
                quant_domain = [
            ...
            elif 'P' in barcode and self.sale_order_id.transfer_type == 'damage':
                lot_code = barcode[barcode.find('P'):]
                quant_domain = [
                    ('lot_id.name', '=', lot_code),
                    ('company_id.nhcl_company_bool', '=', False),
