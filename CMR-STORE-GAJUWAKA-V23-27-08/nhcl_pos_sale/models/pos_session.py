...
class PosSession(models.Model):
    ...
    def _loader_params_hr_employee(self):
        ...
        result['search_params']['fields'].extend(
            ['limited_discount', 'allow_global_discount', 'allow_amount_discount', 'allow_selected_lines_discount', 'max_global_discount', 'max_amount_discount', 'max_selected_lines_discount'])
        return result
