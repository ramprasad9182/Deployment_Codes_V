        ...
        try {
            ...
            // if (startsWithR || hasUnderscore || isLongNumericLot) {
                ...
                if ((!lots || lots.length === 0)) {
                    lots = await this.orm.call('stock.lot', 'search_read', [domain[0], ['id', 'name', 'ref', 'rs_price', 'is_under_plan', 'sale_tax_ids', 'product_qty_pos', 'location_id', 'type_product', 'product_id']], { limit: 1 });
                }
