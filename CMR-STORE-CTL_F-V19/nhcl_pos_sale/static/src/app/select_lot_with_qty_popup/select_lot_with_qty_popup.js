...
import { CustomEditListInput } from "@nhcl_pos_sale/app/select_lot_with_qty_popup/edit_list_input/edit_list_input";
 ...
 *   const { confirmed, payload: newNames } = await this.popup.add(CustomEditListPopup, {
 ...
 * ```
 */
export class CustomEditListPopup extends AbstractAwaitablePopup {
    static components = { CustomEditListInput };
    static template = "nhcl_pos_sale.CustomEditListPopup";
    static defaultProps = {
        confirmText: _t("Add"),
